...
class student (User) :
    def __init__(self , name , lname , code ,email,password,phoneNO,balance) :
        super().__init__()
        self.code = code
    def printName(self) :
        print(f'\nthere is a student named {self.fname} {self.lname} !-!\n')
class teacher (User) : 
    def __init__(self, fName, lName, email, password, phoneNO, balance,):
        super().__init__(fName, lName, email, password, phoneNO, balance)
