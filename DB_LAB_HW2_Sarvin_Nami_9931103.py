...
Q14 = "SELECT P.pname, P.color FROM P WHERE exists(SELECT 'x' FROM S INNER JOIN SP ON SP.p_id = P.p_id and SP.s_id = S.s_id and S.city = 'london') and not exists(SELECT 'x' FROM S INNER JOIN SP ON SP.p_id = P.p_id and SP.s_id = S.s_id and S.city != 'london')"
