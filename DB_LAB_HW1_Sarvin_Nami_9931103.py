...
cursor.execute("CREATE TABLE Term (id INT UNIQUE not null, s_id INT NOT NULL, t_id INT NOT NULL, c# INT NOT NULL, grade INT NOT NULL, term_no INT , PRIMARY KEY(id), FOREIGN KEY(s_id) REFERENCES Student(s_id), FOREIGN KEY(t_id) REFERENCES Teacher(t_id), FOREIGN KEY(c#) REFERENCES Course(c#)))))")
